            ...
            {proceso.map((item, index) => (
              ...
              >
                <div className={`flex-1 ${index % 2 === 0 ? "lg:pr-12" : "lg:pl-12"} mb-8 lg:mb-0`}>
                  <div className="bg-background border border-border rounded-xl p-6 shadow-sm hover:border-primary hover:shadow-md transition-all">
                    <div className="flex items-center mb-4">
                      ...
                      <h3 className="text-2xl font-semibold text-text-primary">{item.paso}</h3>
                    </div>
